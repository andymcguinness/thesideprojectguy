...
// Types
import { IdeaTags, Ideas, Idea, IdeaTag } from "@/pages/ideas/index";
        ...
        <div className="">
          ...
          <form className="hidden lg:block">
            <div role="list" className="pb-6 font-medium text-black items-center flex gap-4 items-middle mt-2">
              ...
              {tags?.allIdeaTags.map((tag : IdeaTag) => (
          ...
          <div className="grid grid-cols-2 gap-x-3 gap-y-3">
            {ideas?.allIdeas.map((idea : Idea) => (
              <div className={classNames(
                (idea.tags.map((tag : IdeaTag) => (tag.slug)).includes(currFilter) || currFilter == "") ? "visible" : "hidden",
