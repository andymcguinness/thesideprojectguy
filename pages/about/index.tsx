  ...
  return (
    <div className="bg-tspg-gray min-h-screen">
      ...
      <main className="pt-10 flex bg-tspg-gray pb-5 h-full w-full">
        <div className="bg-[#ECEDEB] grid grid-cols-3 px-4 py-10 w-full rounded-md mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10 shadow-2xl">
          <div className="col-span-2">
            <h1 className="sm:max-w-xs mb-6 font-sans text-5xl font-bold tracking-tight text-tspg-gray sm:text-4xl sm:leading-none bg-tspg-yellow w-auto inline-flex">About</h1>

            <p className="text-base text-tspg-gray md:text-lg">
              ...
              <br />
              <br />
              You can also check out my Ideas Generator on that page for random ideas!
              <br />
              <br />
              Thanks for stopping by, and take care!
            </p>
          </div>
          <Image src="/andy_pic.jpeg" height={400} width={400} className="rounded-md" alt={""}/>
        </div>
      </main>
    </div>
  )
