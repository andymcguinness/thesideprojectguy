export const Hero = () => {
  return (
    <div className="overflow-hidden bg-tspg-gray pt-4">
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col items-center justify-between xl:flex-row">
          <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12 flex flex-col">
            <h2 className="sm:max-w-xs mb-6 font-sans text-5xl font-bold tracking-tight text-black sm:text-4xl sm:leading-none w-auto inline-flex">
              <span className="bg-tspg-yellow">
              Hiya! I'm Andy!
              </span>
            </h2>
